...
A read receipt proves only that a file was opened. Drafting, auditing and revision must also use:
...
These files prove that prose, style, Holmes, combat, character voice and complete character logic reached the page.
...
- For every decision-relevant canon character, reconcile the stable dossier with `continuity/EVENT_INDEX.md`, relevant event tiles, `continuity/KNOWLEDGE_LEDGER.md`, relationship state and a current character-state file when one exists. The stable dossier alone is not the current character state.
- A physically present character is not automatically decision-relevant. Background presence is allowed. Do not manufacture a line, reaction, habit or competence beat merely to fill a cast row.
...
- `canon/characters/CHARACTER_DOSSIER_APPLICATION.md` applies to every decision-relevant canon character. It is separate from the Voice Pass and requires current-state synthesis, practical or restrictive consequence, removal test, replacement test, existing-ties preservation and spoiler control.
...
| A canon character appears or their decision matters | that person’s dossier in `canon/characters/`; `canon/characters/CHARACTER_DOSSIER_APPLICATION.md`; current character-state when it exists; `continuity/EVENT_INDEX.md`; relevant event tiles; `continuity/KNOWLEDGE_LEDGER.md`; `canon/relationships/RELATIONSHIP_STATE.md` when ties or posture matter |
| Meaningful Mielle/group social interaction, teasing, care, curiosity, disclosure, question, boundary, or reaction to an established Mielle fact | `continuity/EVENT_INDEX.md`; relevant event tiles; `continuity/KNOWLEDGE_LEDGER.md`; relevant character dossiers and states; `canon/characters/CHARACTER_DOSSIER_APPLICATION.md`; `canon/HOLMES_ENGINE.md` when Mielle's reading affects action, silence, disclosure, withholding or response |
...
| Scene cards | chapter plan; chapter mini delta; controlling Arc Map when cross-episode knowledge, obligation or delayed consequence constrains the scene; `C2E1_STARTING_STATE.md` for C2E1 scenes; relevant character dossiers/states; `canon/characters/CHARACTER_DOSSIER_APPLICATION.md`; relationship state; knowledge ledger; `EVENT_INDEX.md`; relevant event tiles; exact setting files; Holmes Engine whenever Mielle's observation, interpretation, withholding or uncertainty can change the scene | scene cards with decision-relevant/background classification, dossier consequence rows, Holmes applicability and scene maps where required |
...
| Chapter loadout | controlling Arc Map; chapter plan; chapter mini delta; scene cards; pre-check if any; `C2E1_STARTING_STATE.md` for C2E1 chapters; `EVENT_INDEX.md`; all exact paths required by targeted-load rules; prose package in `canon/prose/`; `canon/characters/CHARACTER_DOSSIER_APPLICATION.md`; `workflow/01_EXECUTION_APPLICATION_WORKFLOW.md`; `workflow/02_CHARACTER_DOSSIER_APPLICATION_WORKFLOW.md`; decision-to-authority check; execution-system applicability and audit handoff; dossier application handoff; Anti-AI pressure map | chapter loadout |
| Draft | completed loadout and every exact path it names; completed decision-to-authority check; Anti-AI pre-draft guard; `canon/prose/EXECUTION_APPLICATION_RECEIPTS.md`; `canon/characters/CHARACTER_DOSSIER_APPLICATION.md`; both execution workflows; sequential passes in the workflow: factual/continuity, character/relationship, mechanics/Holmes/combat when applicable, prose/voice | draft plus paragraph, scene, voice, dossier, Holmes and combat audit handoff records |
| Audit | draft; previous version when one exists; loadout; chapter plan; chapter mini delta; scene cards; pre-check if any; source extraction; controlling Arc Map; episode map; episode Canon Delta; `C2E1_STARTING_STATE.md` for C2E1 chapters; `EVENT_INDEX.md`; relevant canon, continuity, setting, character, relationship, event, knowledge, Holmes, power, combat and prose-package files; `canon/prose/EXECUTION_APPLICATION_RECEIPTS.md`; `canon/characters/CHARACTER_DOSSIER_APPLICATION.md`; both execution workflows | audit with Prose System, Prose Guide, Holmes, Combat, Character Voice, Character Dossier Application, Mielle invariant and Anti-AI receipts |
| Revise | draft; previous version; audit; every source named by issue; chapter loadout; `canon/prose/EXECUTION_APPLICATION_RECEIPTS.md`; `canon/characters/CHARACTER_DOSSIER_APPLICATION.md`; both execution workflows; exact character dossier and current-state/event anchors for every speaker or actor being revised; exact power module for every capability, defense, no-hit result, evasion, damage result or non-use being revised | revised draft, updated receipts, removal/replacement reruns, version comparison and second-order reread |
| Approve chapter | final draft; closed audit; completed applicable execution receipts including Character Dossier Application; both execution workflows; chapter plan; chapter mini delta | approved chapter record |
...
9. character dossier application handoff;
10. active chapter artifacts.
...
The character dossier handoff must classify decision-relevant versus background presence, reconcile stable dossiers with approved current state, name one productive or restrictive consequence per active character, preserve existing ties, and identify removal/replacement risks. A list of dossier paths is not sufficient.
