...
A read receipt proves only that a file was opened. Planning, drafting, auditing and revision must also use:
...
These files prove that authority strength, prose, style, Holmes, combat, character voice and complete character logic reached the page.

## Obligation-strength binding rule

`workflow/03_PLANNING_OBLIGATION_LEVELS.md` applies to every chapter-planning and prose-production task, including materially rebuilding older work artifacts.

- Level 1 hard authority, Level 2 required semantic outcomes and Level 3 protective constraints may block when violated.
- Level 4 editorial targets guide craft but require demonstrated local damage before they become an audit issue.
- Level 5 execution choices remain free unless they create a continuity, authority, mechanics, knowledge, relationship, physical-coherence or voice failure.
- Repetition across work artifacts does not strengthen an instruction.
- A template field such as `required`, `closed`, `active`, `decision-relevant`, `removal test` or `result` must be interpreted through the assigned obligation level.
- Blanket blocker language in an older template or workflow does not convert optional texture into a hard requirement.

A missing obligation map or a loadout/audit that silently strengthens Level 4–5 material blocks prose authorization or audit closure.
...
- If any canon cast member appears, speaks, acts, reacts, witnesses, withholds, jokes, fights, owns a source beat, or is used as a POV-adjacent presence, read that character's dossier in `canon/characters/` before writing or revising their line or action. Do not write canon cast voices from memory or from a prior draft alone.
- For every required or result-bearing canon-character application, reconcile the stable dossier with `continuity/EVENT_INDEX.md`, relevant event tiles, `continuity/KNOWLEDGE_LEDGER.md`, relationship state and a current character-state file when one exists. The stable dossier alone is not the current character state.
- A physically present character is not automatically decision-relevant. Background and optional texture presence are allowed. Do not manufacture a line, reaction, habit or competence beat merely to fill a cast row.
...
- `canon/characters/CHARACTER_DOSSIER_APPLICATION.md` applies to every required or result-bearing canon-character application. It is separate from the Voice Pass and requires current-state synthesis, practical or restrictive consequence, removal test, replacement test, existing-ties preservation and spoiler control. Optional texture is audited for voice, ownership, knowledge safety and cumulative coverage rather than forced material necessity.
...
| A canon character appears or their decision matters | that person’s dossier in `canon/characters/`; `canon/characters/CHARACTER_DOSSIER_APPLICATION.md`; `workflow/03_PLANNING_OBLIGATION_LEVELS.md`; current character-state when it exists; `continuity/EVENT_INDEX.md`; relevant event tiles; `continuity/KNOWLEDGE_LEDGER.md`; `canon/relationships/RELATIONSHIP_STATE.md` when ties or posture matter |
| Meaningful Mielle/group social interaction, teasing, care, curiosity, disclosure, question, boundary, or reaction to an established Mielle fact | `continuity/EVENT_INDEX.md`; relevant event tiles; `continuity/KNOWLEDGE_LEDGER.md`; relevant character dossiers and states; `canon/characters/CHARACTER_DOSSIER_APPLICATION.md`; `workflow/03_PLANNING_OBLIGATION_LEVELS.md`; `canon/HOLMES_ENGINE.md` when Mielle's reading affects action, silence, disclosure, withholding or response |
| Relationship, intimacy, trust, injury-care, conflict, obligation, or group position matters | `canon/relationships/RELATIONSHIP_STATE.md`; relevant character states; `continuity/EVENT_INDEX.md`; relevant event tiles; relevant stable dossiers |
...
| Combat, pursuit, physical threat, hostile magic, meaningful gear use, consequential power use, injury, no-hit result, evasion or damage resistance occurs | `canon/COMBAT_RULES.md`; `canon/POWER_GUIDE.md`; relevant `canon/mielle_current_power_guide/` module(s); completed pre-check from `templates/COMBAT_TRANSLATION_CARD_TEMPLATE.md`; `canon/HOLMES_ENGINE.md`; relevant combatant dossiers and current approved-event state |
| Drafting or revising prose | `workflow/03_PLANNING_OBLIGATION_LEVELS.md`; `canon/prose/PROSE_SYSTEM.md`; `canon/prose/MIELLE_PROSE_STYLE_GUIDE.md`; `canon/prose/MIELLE_VOICE_GUIDE.md`; `canon/prose/MIELLE_INVARIANT_APPLICATION_TEST.md`; `canon/prose/CHAPTER_PROSE_AND_CHARACTER_VOICE_PASS.md`; `canon/prose/ANTI_AI_PROSE_EDITING_FILTER.md`; `canon/prose/EXECUTION_APPLICATION_RECEIPTS.md`; `canon/characters/CHARACTER_DOSSIER_APPLICATION.md`; `workflow/01_EXECUTION_APPLICATION_WORKFLOW.md`; `workflow/02_CHARACTER_DOSSIER_APPLICATION_WORKFLOW.md` |
...
| Plan chapter | `workflow/03_PLANNING_OBLIGATION_LEVELS.md`; controlling Arc Map; episode map; episode Canon Delta; transcript extraction slice; current continuity; recent chain; open threads; `EVENT_INDEX.md`; last approved chapter; `C2E1_STARTING_STATE.md` for C2E1 chapters; relevant characters, relationship state, setting, event tiles, knowledge ledger and every power module or mechanics source that can affect a planned material fact | chapter plan with obligation map |
| Chapter mini delta | `workflow/03_PLANNING_OBLIGATION_LEVELS.md`; chapter plan; controlling Arc Map; episode Canon Delta; transcript slice; episode map; `C2E1_STARTING_STATE.md` for C2E1 chapters; `EVENT_INDEX.md` when earlier event constrains intervention or knowledge; every exact document governing Mielle’s planned intervention, including character, relationship, setting, power, Holmes, combat, knowledge and event files | `work/c2eX/chapters/XX_CHAPTER_MINI_DELTA.md` preserving plan-level obligation strength |
| Scene cards | `workflow/03_PLANNING_OBLIGATION_LEVELS.md`; chapter plan; chapter mini delta; controlling Arc Map when cross-episode knowledge, obligation or delayed consequence constrains the scene; `C2E1_STARTING_STATE.md` for C2E1 scenes; relevant character dossiers/states; `canon/characters/CHARACTER_DOSSIER_APPLICATION.md`; relationship state; knowledge ledger; `EVENT_INDEX.md`; relevant event tiles; exact setting files; Holmes Engine whenever Mielle's observation, interpretation, withholding or uncertainty can change the scene | scene cards with obligation preservation, decision-relevant/background/optional-texture classification, dossier consequence rows, Holmes applicability and scene maps where required |
| Combat pre-check | `workflow/03_PLANNING_OBLIGATION_LEVELS.md`; chapter plan; chapter mini delta; scene cards; source slice; Mielle dossier/state; relevant combatant dossiers/states and current-event anchors; Combat Rules; Power Guide and exact relevant module(s) for every power, gear item, defense, evasion, prediction, damage result or non-use; Holmes Engine; setting/terrain files | pre-check or combat translation card preserving ownership and obligation levels |
| Chapter loadout | `workflow/03_PLANNING_OBLIGATION_LEVELS.md`; controlling Arc Map; chapter plan; chapter mini delta; scene cards; pre-check if any; `C2E1_STARTING_STATE.md` for C2E1 chapters; `EVENT_INDEX.md`; all exact paths required by targeted-load rules; prose package in `canon/prose/`; `canon/characters/CHARACTER_DOSSIER_APPLICATION.md`; `workflow/01_EXECUTION_APPLICATION_WORKFLOW.md`; `workflow/02_CHARACTER_DOSSIER_APPLICATION_WORKFLOW.md`; decision-to-authority check; obligation-strength preservation check; execution-system applicability and audit handoff; dossier application handoff; Anti-AI pressure map | chapter loadout |
| Draft | completed loadout and every exact path it names; completed decision-to-authority and obligation-strength checks; Anti-AI pre-draft guard; `workflow/03_PLANNING_OBLIGATION_LEVELS.md`; `canon/prose/EXECUTION_APPLICATION_RECEIPTS.md`; `canon/characters/CHARACTER_DOSSIER_APPLICATION.md`; both execution workflows; sequential passes in the workflow: factual/continuity, character/relationship, mechanics/Holmes/combat when applicable, prose/voice | draft plus paragraph, scene, voice, dossier, Holmes and combat audit handoff records |
| Audit | draft; previous version when one exists; loadout; chapter plan; chapter mini delta; scene cards; pre-check if any; source extraction; controlling Arc Map; episode map; episode Canon Delta; `workflow/03_PLANNING_OBLIGATION_LEVELS.md`; `C2E1_STARTING_STATE.md` for C2E1 chapters; `EVENT_INDEX.md`; relevant canon, continuity, setting, character, relationship, event, knowledge, Holmes, power, combat and prose-package files; `canon/prose/EXECUTION_APPLICATION_RECEIPTS.md`; `canon/characters/CHARACTER_DOSSIER_APPLICATION.md`; both execution workflows | audit beginning with obligation-level compliance and containing Prose System, Prose Guide, Holmes, Combat, Character Voice, Character Dossier Application, Mielle invariant and Anti-AI receipts |
| Revise | draft; previous version; audit; every source named by issue; chapter loadout; `workflow/03_PLANNING_OBLIGATION_LEVELS.md`; `canon/prose/EXECUTION_APPLICATION_RECEIPTS.md`; `canon/characters/CHARACTER_DOSSIER_APPLICATION.md`; both execution workflows; exact character dossier and current-state/event anchors for every speaker or actor being revised; exact power module for every capability, defense, no-hit result, evasion, damage result or non-use being revised | revised draft, updated receipts, obligation-strength recheck, removal/replacement reruns where required, version comparison and second-order reread |
| Approve chapter | final draft; closed audit; completed applicable execution receipts including Character Dossier Application; `workflow/03_PLANNING_OBLIGATION_LEVELS.md`; both execution workflows; chapter plan; chapter mini delta | approved chapter record only after the audit confirms no obligation strengthening |
...
6. obligation-strength preservation;
7. decision-to-authority check;
8. prose and editing;
9. execution-system applicability and audit handoff;
10. character dossier application handoff;
11. active chapter artifacts.

A heading with no applicable file must say `not applicable` and give one sentence of justification.

The obligation-strength preservation check must prove that Level 1–3 controls retain their authority, Level 4 targets were not promoted, and Level 5 choices remain free. Generic `closed vs free checked` wording is not sufficient.
...
The character dossier handoff must classify required/result-bearing, meaningful-witness, optional-texture and background presence; reconcile stable dossiers with approved current state; name one productive or restrictive consequence per required application; preserve existing ties; and identify removal/replacement risks. A list of dossier paths is not sufficient.
