...
| Drafting or revising prose | `canon/MIELLE_PROSE_STYLE_GUIDE.md`; `canon/MIELLE_VOICE_GUIDE.md`; `canon/CHAPTER_PROSE_AND_CHARACTER_VOICE_PASS.md`; `canon/ANTI_AI_PROSE_EDITING_FILTER.md` |
...
| Chapter loadout | chapter plan; chapter mini delta; scene cards; pre-check if any; `C2E1_STARTING_STATE.md` for C2E1 chapters; `EVENT_INDEX.md`; all exact paths required by targeted-load rules; prose style guide; Mielle voice guide; chapter prose and character voice pass; Anti-AI filter; decision-to-authority check for every conflict-prone decision, fact, possession state, first-impression rule, power use or non-use | chapter loadout |
...
| Revise | draft; audit; every source named by issue; chapter loadout; `canon/CHAPTER_PROSE_AND_CHARACTER_VOICE_PASS.md`; Anti-AI Silent Edit; exact character dossier for every speaker or actor being revised; exact power module for every capability, defense, no-hit result, evasion, damage result or non-use being revised | revised draft and audit resolution |
