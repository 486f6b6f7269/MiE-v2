...
- She reached the carnival by following the procession and learned the no-weapons procedure, the crowd's movement, and the immediate interior layout of the tent.
- Yasha physically held the bokken with other surrendered weapons until Mielle recalled it during the fight.
- Toya's song began the performance. An old man transformed during the song. A young woman died before Mielle could reach her and later rose as the second creature.
- Mielle recalled the bokken, entered the danger lane, remained unhit, used an ordinary first strike to test hardness, then used black-reinforced counters to break one arm and one leg of each creature.
