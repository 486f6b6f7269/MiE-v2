...
- Transcript extraction: `work/c2e1/TRANSCRIPT_EXTRACTION.md`
- Episode map: `work/c2e1/EPISODE_MAP.md`
- Source notes: `work/c2e1/SOURCE_NOTE.md`; `work/c2e1/chapters/03_SOURCE_COMBAT_NOTE.md`
- Exact files consulted:
  ...
  - `templates/CANON_DELTA_TEMPLATE.md`
...
- Caleb and Nott enter the Nestled Nook as a guarded pair; Nott's public exposure remains their own social problem.
- Rinaldo pays Fjord, Jester and Beau for the rescue that occurred before C2E1.
- The future Mighty Nein establish their first limited contact at the inn.
- Molly and Yasha arrive as carnival workers; Molly owns the invitation to the tavern group.
- The tavern group chooses to attend the carnival.
- Two people transform during the performance.
- The source group retains meaningful combat choices and the Crownsguard retain the official investigation decision.
...
|---|---|---|---|---|
| Rinaldo pays Fjord, Jester and Beau. | Mielle enters only after the payment has ended. She has no connection to the earlier rescue. | Yes. | Her hunger and coins are a separate problem. | Not applicable. |
...
| Character | Source decision or accomplishment | What Mielle may do | What Mielle must not replace |
|---|---|---|---|
| Jester | Offers warmth, opens contact, chooses to attend, makes the ticket offer and opens the combat with direct magic and a duplicate. | Accept food, answer small questions, accept the ticket, hear or react to Jester's alarm, and use the space Jester's opening creates. | Jester's social lead, choice to pay, first magical commitment, duplicate or later support actions. |
| Fjord | Maintains practical caution, calls for weapons and enters a workable combat line. | Hold a creature's attention long enough for Fjord to choose his own target, spell angle or falchion line. | His risk assessment, weapon recovery, decision to close or change targets, or combat contribution. |
| Beau | Tests people, acts physically and ends the second creature. | Keep the two creatures from reaching civilians long enough for Beau to enter a chosen physical lane. | Beau's initiative, movement, close-range choices or finishing action against the second creature. |
| Caleb | Keeps Nott safe, controls disclosure and contributes magic from a protected position. | Avoid sweeping Mielle's containment line through Caleb and Nott; leave him a clear spell line. | Caleb's placement, spell choice, protection of Nott or tactical judgment. |
| Nott | Manages exposure, fear and opportunistic ranged contribution. | Keep a readable opening between bodies for Nott to choose or reject. | Nott's cover, crossbow lane, fear response, joke or chosen risk. |
| Molly | Keeps civilians moving, protects carnival dignity where possible and engages in close combat. | Prevent a creature from running through Molly's immediate lane while he chooses his own blade work. | Molly's evacuation warning, close-combat choice, blood-hunter action or response to harm. |
| Yasha | Keeps weapons, returns them under immediate threat and kills the first creature. | Recall only Mielle's own bokken; do not require Yasha to hand it back. Hold threat attention long enough for Yasha to distribute other weapons and later take the first creature. | Yasha's weapons distribution, safety work, rage, greatsword action or kill. |
| Crownsguard | Attempt to reach danger through panic, take control after both threats fall, investigate and restrict movement. | Be an additional witnessed combatant or witness. | Their legal control, investigation, custody conditions or conclusion. |

## Knowledge effects

### Information created before Chapter 03

- Jester may know Mielle's name, hunger, unfamiliarity with local coins, a visible wooden sword if shown, a dry or unusually literal manner, and whether Mielle accepted the ticket.
- Nearby people may know only what they directly observe or hear. A person can know Jester paid one admission without inferring that Mielle belongs to Jester or the group.
- Molly and Yasha may know Mielle is a paying guest whose entry was covered by Jester. They do not know why Mielle lacks money beyond what Mielle actually says.
...
- Mielle's origin, sealed memory, power ceiling, storage, shelter location, reason for hunger and full combat capacity.
- The value of Mielle's coins unless a visible exchange establishes it.
- The cause of the carnival transformations and each canon character's private history.
- Whether the first creature's attack transmitted the second transformation, and why it did so. Mielle may form a working concern only after visible evidence; she may not know cause before the woman rises.
- Exact legal interpretation of Mielle's recall and combat behavior. This belongs to the approved aftermath and later guard response.

### Knowledge that must not leak from later canon

- Later developments and private histories of Caleb, Nott, Fjord, Beau, Molly and Yasha.
- The cause and later meaning of the transformed creatures.
- Later relationship, travel, faction and plot outcomes.

## Mechanics and power constraints
...
### Board at the first lethal beat

- Mielle begins at the outer front-left edge of the packed semicircle.
- The transforming man rises farther inward in the same left-front sector, oriented toward Toya and the central pole.
- The young woman is between the creature and the crowd's retreating bodies. When she ducks the first blow and falls, the second strike reaches her before Mielle has an unobstructed route.
- Jester and the source group begin toward front-center. Yasha is near the surrendered weapons. Molly, Bo, Gustav, Kylre, Toya, Crownsguard and civilians have independent evacuation or performance tasks.
- The entrance is a bottleneck. The performers' flap is not a public exit. The central pole, uneven dirt and grass, bodies on the ground, and running civilians make direct movement costly.
...
1. Toya's song ends when the old man transforms. Mielle sees no pre-transformation hostile cue that permits a protective strike.
2. Jester makes the first magical commitment. The first creature attacks the young woman. The woman evades once, then is killed in the blocked inward lane.
...
| Source outcome | Does it survive? | Why it remains causally honest with Mielle present | Mielle's permitted effect |
|---|---|---|---|
...
- **Caleb:** protects Nott's position and uses his own magic from a viable line.
- **Nott:** chooses cover, ranged contribution and her fear-driven risk.
- **Molly:** keeps evacuation pressure in view, chooses his own close engagement and absorbs whatever source harm remains his.
- **Beau:** enters physically on her own terms and destroys the second creature.
- **Crownsguard:** fail to reach the first exchange through the crowd, then take public and legal control after the creatures fall.
...
## Relationship and setting consequences

- A meal, an enjoyable exchange and one paid ticket are not a relationship state, debt, promise, group membership, trust or romance.
...
- The source group still reaches the carnival and becomes involved in the public incident.
- Mielle reaches the carnival too. She is a direct witness and an observed combat participant; she cannot later be written as unaware of the transformations or public aftermath.
- The combat-specific review now certifies the Chapter 03 planning boundary. The Chapter 03 combat pre-check remains mandatory before prose.
- The first conversation and paid ticket create no forced party membership, romance, travel agreement, faction attention or ownership.

## Promotion candidates after chapter approval

Only if the final chapter text contains them:

- An event tile or ledger entry for direct witnesses to the food offer, conversation, invitation and ticket offer, with only the facts each can support.
- An event tile and ledger entries for public transformation, creature deaths, visible bokken recall, direct combat witnesses and Crownsguard control, with only the facts each can support.
- A narrow Mielle state update for food accepted, surface fact shared, ticket completed, first public combat, visible recall and immediate emotional remainder.
- No relationship-state update unless approved scenes create an active present behavioral condition.
- No event entry for unshown fight details or guard conclusions.
...
- [x] Chapter 03 is released for chapter planning, mini delta, scene cards and combat pre-check.
- [ ] Chapter 03 is not released for prose until its chapter-specific pre-check and loadout are complete.
