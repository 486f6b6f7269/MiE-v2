...
- Transcript extraction slice: `work/c2e1/TRANSCRIPT_EXTRACTION.md`, causal sequence 1–5.
...
- `canon/COMBAT_RULES.md` — not applicable to Chapter 01 execution: no combat or hostile effect occurs.
- `canon/mielle_current_power_guide/` — not applicable: no named capability is used.
- `templates/COMBAT_TRANSLATION_CARD_TEMPLATE.md` — not applicable: no Chapter 01 combat pre-check is required.
...
| Nott | Manage exposure and limited participation. | Treat her as ordinary and let Nott decide whether to speak or hide. | Nott's fear, humor, concealment or choice. |
| Molly | Enter, read cards and invite people to the carnival. | Listen, ask one ordinary question and decide whether to attend. | Molly's invitation, pitch or performance role. |
| Yasha | Enter with Molly and perform a restrained practical role. | Give her room, answer a direct question or observe. | Yasha's introduction, security or later entry procedure. |
...
- Mielle's origin, shelter, sealed memory, power, stored equipment, actual combat skill and reason for being alone.
- The value of Mielle's coins unless the scene visibly establishes it.
- The private histories and aims of the canon characters.
- The cause of the later carnival transformations and Mielle's later combat response.

### Reader-only / author-only facts that must not leak

- Later group bonds, later private biography, the reason for Nott's body, Caleb's past, Molly's body history, Yasha's past, source of the carnival threat, and later political or travel outcomes.
