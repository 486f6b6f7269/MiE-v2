...
- The first creature treats Mielle as a likely next victim. Mielle avoids the committed attack by a very small margin and strikes its knee to disrupt its line.
- The second creature attacks. Mielle's footwork lets her avoid that initial attack with ease.
...
- In-story prose must not name Haki or its source system. The visible result may be described only as concrete change at the weapon or strike, consistent with the eventual scene choice.
...
- She cannot gain another capability from implication. Any further power beyond Soulbond recall and Armament Haki needs an explicit user decision and an exact mechanics check.
