...
This is the active Chapter 03 combat pre-check. It implements `03_COMBAT_SCOPE_AMENDMENT.md` and supersedes the combat choreography in `03_COMBAT_PRECHECK.md` wherever they differ.

## Source situation

The carnival performance becomes a civilian emergency. An old man transforms inward of Mielle's outer front-left seat, kills a young woman after Jester's first magical action, and the woman later becomes a second creature. The exit bottlenecks. The source group is initially disarmed because Yasha holds the weapons. Crownsguard cannot reach the active danger through the crowd.

## Non-negotiable source outcomes

- The first woman dies, then becomes the second creature.
- Jester opens with magic and a duplicate.
- Yasha distributes weapons, then kills the first creature.
- Fjord, Caleb, Nott and Molly each make meaningful combat choices.
- Beau destroys the second creature.
- Crownsguard seize control and restrict departure from Trostenwald.

## Board

- Mielle: outer front-left at first; moves inward only after the woman's death through the gap left by the creature's attack; bokken appears in her hand during approach.
- Group: Jester, Fjord, Beau, Caleb and Nott begin front-center; Yasha is near the weapons; Molly is on carnival work side.
- Creatures: first creature is in the inward left-front sector; second rises from the woman's body.
- Civilians: the crush at the main entrance, performers and workers using the back flap, remaining audience bodies between lines.
- Terrain: central pole, uneven dirt, grass, stone, bodies and scattered weapons. No clean fight lane exists until the crowd thins.

## Why the first death still follows

The transformation and first attack have no readable precursor. The victim and creature are inward of Mielle's edge position. Before the second strike, civilians fold into the route between them. Mielle cannot reach the victim without forcing a new collision and trampling line. Her surprise is real, short and not treated as a loss of ability.

## Mielle’s combat sequence

1. After the death, Mielle walks inward empty-handed. She does not charge through civilians or issue group commands.
...
- Jester: first magic and duplicate; later support on her own initiative.
- Yasha: weapon distribution, greatsword lane and first kill.
- Fjord: own weapon, spell or melee choice.
- Caleb: protects Nott and chooses his spell line.
- Nott: chooses cover and a frightened but meaningful ranged action.
- Molly: chooses his warning, blade work and risk.
- Beau: enters physically on her own terms and owns second-creature finish.
- Mielle: active co-fighter after weapons return, never the commander of these lanes.
...
- No saving the first woman retroactively.
- No cure, healing, mass protection, teleportation, mind-reading, crowd control or unchosen capability.
- No Mielle finish against either creature.
- No group membership, trust claim or command hierarchy created by the fight.
- No system names in-story.

## Result

The Chapter 03 combat pre-check is complete for planning. The remaining required steps before prose are the Chapter Loadout and pre-draft guard.
